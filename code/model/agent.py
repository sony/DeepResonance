...
class DeepSpeedAgent:
    ...
    def train_model(self, batch, current_step=0, pbar=None, timeout=10):
    ...
    def print_model_parameters(self, use_4bit=False):
        ...
        for name, param in self.model.named_parameters():
            ...
            elif 'preencoding' in name:
                preencoding += num_params
            
            if 'llama_model.base_model.model.model.embed_tokens.weight' in name:
                llama_embeds += num_params
            
            if 'llama_model.base_model.model.lm_head.weight' in name:
                lmhead += num_params
        ...
        print(f'lora params: {lora:,d} || llama embed params: {llama_embeds:,d} || llama lmhead params: {lmhead:,d}')
        print(f'pre-llm fusion params: {preencoding:,d} || linear adaptor params: {linear:,d}')
        print(f'imagebind params: {imagebind:,d} || llama params: {llama:,d}')
