        ...
        for modality_key, modality_value in inputs.items():
            ...
            if modality_value is not None:
                ...
                if reduce_list:
                    ...
                    outputs[modality_key] = modality_value.mean(dim=1)
                else:
                    outputs[modality_key] = modality_value
                if len(modality_value.shape) == 3:
                    outputs[f'{modality_key}_original'] = modality_value
                else:
                    outputs[f'{modality_key}_original'] = modality_value.unsqueeze(dim=1)
